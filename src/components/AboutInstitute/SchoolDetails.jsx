...
import callWhiteIcon from "../../assets/icons/call-white.png";
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-col items-center text-primary">
        ...
        <span className="bg-primary p-2 lg:p-3 flex gap-2 items-center mt-4 mb-2 rounded-sm">
          <img src={callWhiteIcon} alt="" className="h-8" />
          <h4 className="text-textColor text-2xl">{data.headmaster_mobile}</h4>
        </span>
        <h4 className="text-lg font-medium text-primary font-poppins text-center">
          {data.institute_web}
        </h4>
      </div>
    </div>
